...
//#define FSPEC02_I253_000 0x40
//#define FSPEC03_I253_030 0x20
//#define FSPEC04_I253_020 0x10
//#define FSPEC05_I253_041 0x08
//#define FSPEC06_I253_050 0x04
//#define FSPEC07_I253_060 0x02
//
//#define FSPEC08_I253_070 0x80
//#define FSPEC09_I253_100 0x40
//#define FSPEC10_I253_110 0x20
//#define FSPEC11_I253_120 0x10
//#define FSPEC12_I253_090 0x08
//#define FSPEC13_I253_RE  0x04
//#define FSPEC14_I253_SP  0x02
...
bool Asterix252_to_RadarService (const void *data, int size,
	deque < RDFRadarService > &service_list)
{
	...
	if ((config = g_getenv ("Asterix252")))
	{
		...
		{
			cms_warning ("unknown Asterix252 value");
		}
	}
	...
	while (record < msg + len)
	{
		...
		if (*fspec & FSPEC13_I253_RE)
		{
			field += field[0];
		}

		// special purpose field
		if (*fspec & FSPEC14_I253_SP)
		{
			if (config_nosp)
			{
				field += field[0];
...
int RadarService_to_Asterix252 (deque < RDFRadarService > &service_list,
	void *data, int maxsize)
{
	...
	while (service_list.size () > 0)
	{
		...
		*fspec |= FSPEC_FX;
		...
		if (0)
		{
			*fspec |= FSPEC08_I253_070;
		}

		// generic polar window
		if (0)
		{
			*fspec |= FSPEC09_I253_100;
		}

		// data filter
		if (service.DataFilter)
		{
			*fspec |= FSPEC10_I253_110;
